...
//handle slider for setting password length
...
function generateLowerCase(){
    return String.fromCharCode (getRandomInteger(97,123)) ;  //97=a  //z=123
...
for(let i=0;i<passwordLength-funcArr.length;i++){
    let randmIndex=getRandomInteger(0 , funcArr.length);
